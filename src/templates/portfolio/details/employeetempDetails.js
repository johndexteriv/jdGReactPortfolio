...
import portfolioDetailsData from "../../../data/portfolio/employeetemplate.json";

const EmployeeTempDetails = () => {
	return (
				...
				<Row>
					<Col lg={7}>
						<PortfolioDetailsThumb
							images={portfolioDetailsData.previewImages}
						/>
					</Col>
...
export default EmployeeTempDetails;
